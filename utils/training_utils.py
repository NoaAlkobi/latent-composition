...
def make_parser():
    ...
    parser.add_argument('--lambda_c_norm', default=10, type=float, help='loss weighting (image mse)')
    parser.add_argument('--lambda_lpips', default=1.0, type=float, help='loss weighting (image perceptual)')
    parser.add_argument('--lambda_c', default=1.0, type=float, help='loss weighting (image perceptual)')
    ...
    parser.add_argument('--number_of_classes', type=int, default=100)
    parser.add_argument('--predict_class', type=int, default=2) # 1 - one number only between 0 to 1 # 2 - one hot vector - 1000 values # 3 - c_shared unsupervised, #4 c_shared- nearest_neighbor
    # parser.add_argument('--predict_class_one_hot', type=int, default=0) # 1 - one number only between 0 to 1 # 2 - one hot vector - 1000 values
    parser.add_argument('--resolution', type=int, default=256)
    parser.add_argument('--mask_width', type=int, default=32)
