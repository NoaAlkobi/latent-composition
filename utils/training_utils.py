...
def make_parser():
    ...
    parser.add_argument('--number_of_classes', type=int, default=999)
    parser.add_argument('--predict_class', type=int, default=0)
    parser.add_argument('--predict_class_one_hot', type=int, default=1)
